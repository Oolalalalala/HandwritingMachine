...
#define DISPLACEMENT_PER_STEP (5.0f * 2 * PI / STEPPER_STEPS_PER_REVOLUTION / STEPPER_MICROSTEPS) // (mm)
#define CONSECUTIVE_NEXT_ACTION_INTERVALS 0 // (us), if next action interval is less than this, we keep updating the steppers

#define CAP_RPM 600.0f // The max speed of the stepper motor, when too low, may cause the motors to desync
